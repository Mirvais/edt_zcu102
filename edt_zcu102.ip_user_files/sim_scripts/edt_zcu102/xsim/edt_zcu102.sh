...
#
# Script generated by Vivado on Thu Feb 26 00:45:06 +0100 2026
...
#
# Usage        : edt_zcu102.sh
#                edt_zcu102.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                edt_zcu102.sh [-reset_run]
#                edt_zcu102.sh [-reset_log]
#                edt_zcu102.sh [-help]
#
...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_21 -L zynq_ultra_ps_e_vip_v1_0_21 -L xilinx_vip"

# script info
echo -e "edt_zcu102.sh - Script generated by export_simulation (Vivado v2025.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./edt_zcu102.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_21 -L zynq_ultra_ps_e_vip_v1_0_21 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot edt_zcu102 xil_defaultlib.edt_zcu102 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim edt_zcu102 -key {Behavioral:sim_1:Functional:edt_zcu102} -tclbatch cmd.tcl -protoinst "protoinst_files/edt_zcu102.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb edt_zcu102.wdb xsim.dir libdpi.so)
...
Usage: edt_zcu102.sh [-step]\n\
Usage: edt_zcu102.sh [-lib_map_path]\n\
Usage: edt_zcu102.sh [-reset_run]\n\
Usage: edt_zcu102.sh [-reset_log]\n\
Usage: edt_zcu102.sh [-keep_index]\n\
