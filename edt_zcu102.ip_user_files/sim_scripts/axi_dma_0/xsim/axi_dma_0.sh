...
#
# Script generated by Vivado on Thu Mar 19 06:01:27 +0100 2026
# SW Build 6233196 on Thu Sep 11 21:27:30 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi_dma_0.sh
...
#
# Usage        : axi_dma_0.sh
#                axi_dma_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_dma_0.sh [-reset_run]
#                axi_dma_0.sh [-reset_log]
#                axi_dma_0.sh [-help]
#
...
export RDI_DATADIR="D:/VLSI/Xilinx/2025.1.1/Vivado/data"

# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_21 -L zynq_ultra_ps_e_vip_v1_0_21 -L xilinx_vip"

# set xvhdl options
xvhdl_opts="--incr --relax "

# script info
echo -e "axi_dma_0.sh - Script generated by export_simulation (Vivado v2025.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_dma_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_datamover_v5_1_37 -L axi_sg_v4_1_21 -L axi_dma_v7_1_36 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_dma_0 xil_defaultlib.axi_dma_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_dma_0 -key {Behavioral:sim_1:Functional:axi_dma_0} -tclbatch cmd.tcl -protoinst "protoinst_files/edt_zcu102.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/VLSI/Xilinx/2025.1.1/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_dma_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_dma_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_dma_0.sh [-help]\n\
Usage: axi_dma_0.sh [-step]\n\
Usage: axi_dma_0.sh [-lib_map_path]\n\
Usage: axi_dma_0.sh [-reset_run]\n\
Usage: axi_dma_0.sh [-reset_log]\n\
Usage: axi_dma_0.sh [-keep_index]\n\
Usage: axi_dma_0.sh [-noclean_files]\n\n\
